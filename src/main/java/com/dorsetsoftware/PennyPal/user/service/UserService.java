package com.dorsetsoftware.PennyPal.user.service;
...
public class UserService  implements UserDetailsService {
    ...
    @Transactional
    public UserDto updateCurrentUserProfile(String username, UserProfileUpdateDto dto) {
        User user = userRepository.findByUsername(username);
        if (user == null) {
            throw new UsernameNotFoundException("User Not Found with username: " + username);
        }
        user.setAlias(dto.getUsername());
